...
5. Lack of yearly test forecasts in favor of a single 5-year test forecast
6. Table 4! 
    ...
    - Why only top 30?
7. Treating the output of a RF regression model as Pr() -- (RM: I guess this is akin to a Linear Probability Model, but I'm not sure if this is possible in a RF framework
