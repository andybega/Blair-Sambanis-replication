...
Although smoothing might appear to be a simple option to aid in the visual interpretation of ROC curves, and is presented as such by B&S, it actually involves estimating an underlying population ROC curve, using a parametric binormal model in this case. There is a literature in statistics and the medical field on such ROC estimators and the conditions under which they might be preferable to ...
...
Far from being a trivial choice, the question of whether to use ROC estimates rather than the empirical ROC curves is a major decision that dramatically impacts the results. B&S do not offer a justification for departing from the common practice of using the empirical ROC curves. 
