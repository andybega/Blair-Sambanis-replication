...
Conversely, not all factors that are "theoretically" important are also important for prediction, and some factors that turn out to be good predictors do not originate from prior theory. For example, both @wgb:2007 and @hill:jones:2014 examine a variety of variables that are considered "theoretically" important for explaining civil war onset and state repression, respectively, and find that there is substantial variation in how useful they are for for actually predicting those outcomes. 
