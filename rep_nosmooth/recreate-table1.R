...
#
# knitr::kable(tab_dat, "latex", booktabs = TRUE, linesep = "\\addlinespace", digits = c(2),
#              label = "tab-1", caption = "Replication of Table 1 in Blair and Sambanis (2020) with and without ROC smoothers", align = c(rep("l", 3), rep("c", 5))) %>%
