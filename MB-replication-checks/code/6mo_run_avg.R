...
prediction <- as.numeric((prediction_escalation_6mo_inc_civil_ns +
                            prediction_quad_6mo_inc_civil_ns +
                            prediction_goldstein_6mo_inc_civil_ns +
                            prediction_all_CAMEO_6mo_inc_civil_ns)
                         /4)

# prediction_robust_maxnodes <- as.numeric((prediction_robust_maxnodes_escalation_6mo_inc_civil_ns +
#                                 prediction_robust_maxnodes_quad_6mo_inc_civil_ns +
#                                 prediction_robust_maxnodes_goldstein_6mo_inc_civil_ns +
#                                 prediction_robust_maxnodes_all_CAMEO_6mo_inc_civil_ns)
#                              /4)
#
# prediction_robust_sampsize <- as.numeric((prediction_robust_sampsize_escalation_6mo_inc_civil_ns +
#                                 prediction_robust_sampsize_quad_6mo_inc_civil_ns +
#                                 prediction_robust_sampsize_goldstein_6mo_inc_civil_ns +
#                                 prediction_robust_sampsize_all_CAMEO_6mo_inc_civil_ns)
#                              /4)
#
# prediction_robust_ntree <- as.numeric((prediction_robust_ntree_escalation_6mo_inc_civil_ns +
#                              prediction_robust_ntree_quad_6mo_inc_civil_ns +
#                              prediction_robust_ntree_goldstein_6mo_inc_civil_ns +
#                              prediction_robust_ntree_all_CAMEO_6mo_inc_civil_ns)
#                           /4)
#
# prediction_robust_traintest1 <- as.numeric((prediction_robust_traintest1_escalation_6mo_inc_civil_ns +
#                                   prediction_robust_traintest1_quad_6mo_inc_civil_ns +
#                                   prediction_robust_traintest1_goldstein_6mo_inc_civil_ns +
#                                   prediction_robust_traintest1_all_CAMEO_6mo_inc_civil_ns)
#                                /4)
#
# prediction_robust_traintest2 <- as.numeric((prediction_robust_traintest2_escalation_6mo_inc_civil_ns +
#                                   prediction_robust_traintest2_quad_6mo_inc_civil_ns +
#                                   prediction_robust_traintest2_goldstein_6mo_inc_civil_ns +
#                                   prediction_robust_traintest2_all_CAMEO_6mo_inc_civil_ns)
#                                /4)
#
# prediction_robust_traintest3 <- as.numeric((prediction_robust_traintest3_escalation_6mo_inc_civil_ns +
#                                   prediction_robust_traintest3_quad_6mo_inc_civil_ns +
#                                   prediction_robust_traintest3_goldstein_6mo_inc_civil_ns +
#                                   prediction_robust_traintest3_all_CAMEO_6mo_inc_civil_ns)
#                                /4)
#
#
# prediction_robust_civil_ns_alt1 <- as.numeric((prediction_robust_civil_ns_alt1_escalation_6mo_inc_civil_ns +
#                                      prediction_robust_civil_ns_alt1_quad_6mo_inc_civil_ns +
#                                      prediction_robust_civil_ns_alt1_goldstein_6mo_inc_civil_ns +
#                                      prediction_robust_civil_ns_alt1_all_CAMEO_6mo_inc_civil_ns)
#                                   /4)
#
# prediction_robust_civil_ns_alt2 <- as.numeric((prediction_robust_civil_ns_alt2_escalation_6mo_inc_civil_ns +
#                                      prediction_robust_civil_ns_alt2_quad_6mo_inc_civil_ns +
#                                      prediction_robust_civil_ns_alt2_goldstein_6mo_inc_civil_ns +
#                                      prediction_robust_civil_ns_alt2_all_CAMEO_6mo_inc_civil_ns)
#                                   /4)
...
write.csv(tbl, "tables/auc-6mo-avg.csv", row.names = FALSE)
# Calculate PR
...
pred_avg_6mo_inc_civil_ns <- data.frame(cbind(country, year, period,
                                              incidence_civil_ns, incidence_civil_ns_plus1,
                                              prediction))

colnames(pred_avg_6mo_inc_civil_ns) <- c("country", "year", "period",
                                         "incidence_civil_ns", "incidence_civil_ns_plus1",
                                         "prediction")
...
AUCs_avg_6mo <- AUCs
prediction_avg_6mo_inc_civil_ns <- prediction
# prediction_robust_maxnodes_avg_6mo_inc_civil_ns <- prediction_robust_maxnodes
# prediction_robust_sampsize_avg_6mo_inc_civil_ns <- prediction_robust_sampsize
# prediction_robust_ntree_avg_6mo_inc_civil_ns <- prediction_robust_ntree
# prediction_robust_traintest1_avg_6mo_inc_civil_ns <- prediction_robust_traintest1
# prediction_robust_traintest2_avg_6mo_inc_civil_ns <- prediction_robust_traintest2
# prediction_robust_traintest3_avg_6mo_inc_civil_ns <- prediction_robust_traintest3
# prediction_robust_civil_ns_alt1_avg_6mo_inc_civil_ns <- prediction_robust_civil_ns_alt1
# prediction_robust_civil_ns_alt2_avg_6mo_inc_civil_ns <- prediction_robust_civil_ns_alt2
roc_avg_6mo_inc_civil_ns <- roc
roc_noSmooth_avg_6mo_inc_civil_ns <- roc_noSmooth
# precision_recall_avg_6mo_inc_civil_ns <- precision_recall
# brier_obs_avg_6mo_inc_civil_ns <- brier_obs
# RF_ranking_avg_6mo_inc_civil_ns <- RF_ranking
# f1_max_avg_6mo_inc_civil_ns <- f1_max
